...
public class User {
    ...
    public static String getNewUsername(Scanner scanner, ArrayList<User> users){
        ...
        while(!valid){
            ...
            username = Utils.getInput(scanner, conditions, prompt);
    ...
    public static String getNewUserType(Scanner scanner){
        ...
        return Utils.getInput(scanner, condition, prompt).toUpperCase();
    }
    ...
    public String getUserAsString() {
        return Utils.pad(this.username, 16) + this.usertype;
    }
}
